...
import { Typography, Box, useMediaQuery, InputLabel, MenuItem, FormControl, Select } from "@mui/material";
  ...
  return (
    <div>
      ...
      >
        ...
        {
          country === 'USA' ? <USAPrivacy variant={variant} /> : <IndiaPrivacy variant={variant} />
        }
      </Box>
      <Footer />
    </div>
...
function USAPrivacy({ variant }) {
  return (
    <>
      <Box sx={{ color: "#95b2af" }}>
        <Typography sx={{ mt: 6, fontSize: "16px" }}>
          Vapormop.com is a website owned by Vrisan Group LLC, an entity incorporated Under the Delaware corporation with its address at-
          <br />
          <br />
          Wherever the term “Vapormop” or “Vapormop.com” or “Vapormop Home Services” is used it refers to Vapormop, and its subsidiaries, controlled entities, affiliates and related parties. Vapormop provides the services through www.Vapormop.com (‘Website’ or ‘Site’ or App).
          <br />
          <br />
          At Vapormop, we are highly committed to the privacy of your data and information and in providing excellent service to all of our customers and visitors of the Website. We have prepared this Data Protection and Privacy Policy (“Policy”) to inform you of the privacy principles that govern this Website. <br />
          <br />
        ...
        <Typography sx={{ mt: 6, fontSize: "16px" }}>
          ...
          <br />
          <br />
          The terms and conditions set forth below through the Privacy Policy constitute a legally-binding agreement between Vapormop, a wholly-owned subsidiary of Vrisan Group, and you. This policy contains provisions that define your limits, legal rights and obligations with respect to your use of and participation on the Platform, including the classified advertisements, forums, various email functions and Internet links, and all content and Vapormop available on the Platform. The Privacy Policy is applicable to all users of the Platform, including users who have access and/or register on the Platform, and users who are also contributors of content, information, private and public messages, advertisements, and other materials or services on the Platform.
        </Typography>
...
function IndiaPrivacy({ variant }) {
  return (
    <>
      <Box sx={{ color: "#95b2af" }}>
        <Typography sx={{ mt: 6, fontSize: "16px" }}>
          Vapormop.com is a website owned by Vrisan Group, an entity incorporated Under the Shop and Establishment Act, 1963 registration.
          <br />
          <br />
