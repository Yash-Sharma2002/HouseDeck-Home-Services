                    ...
                    <Box>
                        <div className='childdiv' style={{ padding: '15px' }}>
                            {options.innerData.map((data) => {
                                ...
                                const price = data.actual
                                const fakePrice = data?.discount 
                                return (
                                    <>
                                        <Box key={data.type}>
                                            ...
                                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '8px 4px' }}>
                                                ...
                                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', }}>
                                                    {
                                                        price !== fakePrice &&
                                                        <Typography sx={{ fontSize: '17px', fontWeight: '600', fontFamily: 'Fredoka', textDecoration: 'line-through', color: 'gray' }}>Rs. {fakePrice}</Typography>
                                                    }
                                                    <Typography sx={{ ml: 2, fontSize: '18px', fontWeight: '600', fontFamily: 'Fredoka' }}>Rs. {price}</Typography>
                                                </Box>
                                            </Box>
