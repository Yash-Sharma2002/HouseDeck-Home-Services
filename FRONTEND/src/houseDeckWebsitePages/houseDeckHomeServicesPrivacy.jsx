      ...
      >
        ...
        <Box sx={{ color: "#95b2af" }}>
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            HouseDeck.in is a website owned by HouseDeck Furnishing Private Limited, a company incorporated under the Indian Companies Act, 1956.
            <br />
            <br />
            Wherever the term “HouseDeck” or “HouseDecklite.com” or “HouseDeck Home Services” is used it refers to HouseDeck Furnishing Pvt Ltd, and its subsidiaries, controlled entities, affiliates and related parties. HouseDeck provides the services through www.housedeck.in (‘Website’ or ‘Site’).
            <br />
            <br />
            At HouseDeck, we are highly committed to the privacy of your data and information and in providing excellent service to all of our customers and visitors of the Website. We have prepared this Data Protection and Privacy Policy (“Policy”) to inform you of the privacy principles that govern this Website.
            <br />
            <br />
            Unless restricted by applicable law, you agree that all your personal information collected by HouseDeck through the Website may be used and disclosed as set out in this Policy.
          </Typography>\
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            You are advised to read this Policy carefully. By accessing the services provided by HouseDeck.in you agree to the collection and use of your data by HouseDeck.in and certain authorized third party service providers in the manner provided in this Policy. The terms and conditions set forth below through the Privacy Policy constitute a legally-binding agreement between HouseDeck Furnishing Pvt. Ltd. (“HouseDeck”), and you.
            <br />
            <br />
            This policy contains provisions that define your limits, legal rights and obligations with respect to your use of and participation on the Platform, including the classified advertisements, forums, various email functions and Internet links, and all content and HouseDeck services available on the Platform. The Privacy Policy is applicable to all users of the Platform, including users who have access and/or register on the Platform,
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            At HouseDeck, we are extremely committed to protect your privacy. We would like you to feel confident about us, use our services freely and recommend our services to your friends and family. <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            When you sign up on the Platform we collect personal information from (i) users who are interested in availing our services, (ii) design partners who offer their design services to HouseDeck customers (“Design Partners”), and (iii) service partners offering their services (“Service Partners”).
            <br />
            <br />
            Personal information collected from Design Partners and Service Partners may be partially or completely accessible to users on of the Platform or those availing our services. Personal information from users availing our services is partially or completely available to relevant Design Partner(s), Service Partner(s) and employee(s) of HouseDeck on a need to know basis.
            <br />
            <br />
            All information disclosed by you shall be deemed to be disclosed willingly and without any coercion. No liability pertaining to the authenticity/ genuineness/ misrepresentation/ fraud/ negligence, etc. of the information disclosed shall lie on HouseDeck nor will HouseDeck in any way be responsible to verify any information obtained from you.
          </Typography>
          <Typography
            sx={{
              mt: 4,
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            HouseDeck may also use aggregate information and statistics for the purposes of monitoring website usage in order to help us develop the Website, our products and services and may provide such Aggregate information to third parties on an aggregate basis.
            <br />
            <br />
            These statistics will not include information that can be used to identify any individual customer.
            <br />
            <br />
            HouseDeck may organize contests and surveys and the information collected during these events may be used by HouseDeck to improve your overall customer experience. The information will only be shared with third parties on an aggregate basis.
            <br />
            <br />
            ...
            <br />
            <br />
            Personal data collected by the Website may be transferred to other sites of HouseDeck where it is necessary to meet the purpose for which you have submitted the information. By submitting data on this Website, you are providing explicit consent to transmission of data collected on the Website.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            HouseDeck business partners through which you create or access your HouseDeck account, such as payment providers, social media services, or apps or websites who use HouseDeck’s APIs or whose API HouseDeck uses-
            <br />
            <br />
            ...
            <br />
            <br />
            HouseDeck may combine the information collected from these sources with other information in its possession.
            <br />
            <br />
            By choosing to provide any and all of the aforesaid information to Us, you are giving HouseDeck permission to use and/or store such information consistent with this Privacy Policy.
            <br />
            <br />
            Further, HouseDeck shall be entitled to retain your Personal information for such duration as may be required for the purposes specified hereunder and shall be used us only in accordance with this Privacy Policy.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            to respond to claims that any photo, text, or other material violates the rights of third parties; or to protect the rights, property, or personal safety of HouseDeck, its users, or the general public.We provide certain required personal and contact information to our subsidiaries, affiliated companies or other trusted business partners for the purpose of providing the required service on our behalf. We require that these parties agree to process such information based on our instructions and in compliance with this Policy and any other appropriate confidentiality and security measures.
            <br />
            <br />
            If HouseDeck becomes involved in a merger, acquisition, or any form of sale of some or all of its assets, we will inform you through e-mail before personal information is transferred and that may become subject to a different privacy policy.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            We restrict access to personal information to HouseDeck employees, contractors and agents who need to know that information in order to operate, develop or improve our services. These individuals are bound by confidentiality obligations and may be subject to discipline, including termination and criminal prosecution, if they fail to meet these obligations.
            <br />
            <br />
            ...
            <br />
            <br />
            You further agree that you are solely responsible and liable for, and shall indemnify HouseDeck against any and all costs, expenses, damages, fees, etc. that HouseDeck may incur or suffer due to any personal information or other materials that you post, upload, submit, and otherwise make available on the Website, including areas of the Website that are available to the public.
            <br />
            <br />
          ...
          >
            Communications among users and with HouseDeck partners:
          </Typography>

          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            To offer our services, or to facilitate HouseDeck Partners to offer their services, personal information, partially or fully, is made available to users of HouseDeck. As an example, when you sign up to receive services from HouseDeck, your contact information including phone number and email is shared with a Design Partner and/or Service Partner to offer his/her service for your project. Sometimes, the users are allowed to contact each other for marketing purposes as well.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Information not controlled by HouseDeck –
            <br />
            <br />
            This Platform may contain links to other websites or resources over which HouseDeck does not have any control. Such links do not constitute an endorsement by HouseDeck of those external websites.
            <br />
            <br />
            You acknowledge that HouseDeck is providing these links to you only as a convenience, and further agree that HouseDeck is not responsible for the content of such external websites.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            HouseDeck uses information collected about you (including recordings of customer support calls after notice to you and with your consent) to assist you when you contact our customer support services, including to:
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            HomeDeck.com regularly reviews its compliance with this Policy. Please feel free to direct any questions or concerns regarding this Policy or HouseDecklite.com’s treatment of personal information by contacting us through this Website or by e-mailing to us at care@housedeck.in . When we receive complaints at this address, it is HouseDecklite.com’s policy to contact the complaining user regarding his or her concerns.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            In such an event HouseDeck shall be under no obligation to inform you or seek your approval or consent.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            In the event You have any grievances relating to the Privacy Policy, please inform HouseDeck within 24 hours of occurrence of the instance from which the grievance has arisen, by writing an email to the Grievance Officer at  <a style={{ textDecoration: 'underline', color: 'pink' }} href="mailto: admin@housedeck.in">admin@housedeck.in</a>.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Any dispute, controversy or claim directly or indirectly caused by, arising out of or relating to this Policy will be governed by the laws of India and will be referred to confidential, mandatory and binding arbitration in Bengaluru, India. The arbitration will be conducted on an expedited basis before a single arbitrator appointed by HouseDeck in accordance with the provisions of the Indian Arbitration and Conciliation Act, 1996. The arbitrator’s award shall be substantiated in writing and will be final and binding on you and HouseDeck. Subject to the above, you agree to submit yourself to the exclusive jurisdiction of the Courts in Bengaluru, India.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            You may change your interests at any time and may opt-in or opt-out of any marketing / promotional / newsletters mailings. HouseDeck.in reserves the right to send you certain service related communication, considered to be a part of your housedeck.com account without offering you the facility to opt-out. You may update your information and change your account settings at any time.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            HouseDeck takes your privacy very seriously. This privacy policy (“Privacy Policy”) is intended to inform you about the information that is collected from you when you visit website and applications owned by HouseDeck and operated in India by Housedeck Furnishing Private Limited (the “Platform”); how this information may be used and disclosed; and how your information is protected. HouseDeck manages personal data in accordance with the Information and Technology Act, 2000 and rules framed thereunder, from time to time.
            <br />
            <br />
            Housedecklite.com is the property of HouseDeck , having its registered office at NO.1, T.C. PALLYA SONNATHAMMANAHALLI K.R.PURAM Bangalore KA -560036  and is currently managed and operated in India by its affiliate or parent company Housedeck Furnishing Private Limited.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <br />
            The terms and conditions set forth below through the Privacy Policy constitute a legally-binding agreement between HouseDeck,  a wholly-owned subsidiary of Housedeck Furnishing Private Limited., and you. This policy contains provisions that define your limits, legal rights and obligations with respect to your use of and participation on the Platform, including the classified advertisements, forums, various email functions and Internet links, and all content and Housedeck available on the Platform. The Privacy Policy is applicable to all users of the Platform, including users who have access and/or register on the Platform, and users who are also contributors of content, information, private and public messages, advertisements, and other materials or services on the Platform.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Housedeck offers the opportunity to any user to share details of anyone who they think may be interested in Housedeck or our services. This information is recorded and used only to communicate with the referee using mediums including phone calls and email, based on the details provided to Housedeck. We believe that it is within the purview of the referrer to seek authorization to share the personal information of the referee. When the information is shared with Housedeck, it is deemed that the authorization has already been obtained by the referrer.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            ...
            <br />
            <li>Housedeck business partners through which you create or access your Housedeck account, such as payment providers, social media services, or apps or websites who use Housedeck’s APIs or whose API Housedeck uses</li>
            <br />
            ...
            <br />
            <br />
            By choosing to provide any and all of the aforesaid information to Us, you are giving Housedeck permission to use and/or store such information consistent with this Privacy Policy. Further, Housedeck shall be entitled to retain your Personal information for such duration as may be required for the purposes specified hereunder and shall be used us only in accordance with this Privacy Policy.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Housedeck uses the information we collect to provide, personalize, maintain and improve our products and services. This includes
            <br />
            <br />
            ...
            <br />
            <br />
            We confirm that the information that we collect from you may be used in aggregate form in various ways to optimize and improve Housedeck’s services, understand usage trends, analyse behavioural patterns, determine the effectiveness and usefulness of services and/or communications shared with you. While such information may be based on information about you, it will not identify you personally.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Housedeck uses the information shared by you to communicate with you, including for the purpose of project updates, customer experience surveys, promotional offers and account information. The mode of communication includes emails, electronic newsletters, invitations, polls and surveys.
          </Typography>
          ...
          >
            Communication amongst users and with Housedeck
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Housedeck does not sell or transfer your Personal information (including your phone number, email address) to third-parties for the use of their own marketing.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            You (including Design Partners and Service Partners) may provide your feedback, reviews, comments, content, other information etc. on the Platform (“Posts”). Your Posts shall have to comply with the conditions relating to Posts as mentioned in the Terms of Use. Housedeck retains an unconditional right to remove and delete any Post or such part of the Post that, in the opinion of Housedeck, does not comply with the conditions in the Terms of Use. [All Posts shall be publicly accessible and visible to all Users of the Platform.] Housedeck reserves the right to use, reproduce and share Your Posts for any purpose. If you delete Your Posts from the Platform, copies of such Posts may remain viewable in archived pages, or such Posts may have been copied or stored by other users.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            To avail Housedeck service(s), you may give us consent to share such personal information, as may be required, with our Design Partners/ Service Partners offering those services. In the event of such a request, Housedeck shares only the information necessary for them to offer the specific service. All Design Partners and Service Partners are required to follow appropriate confidentiality and safety measures to protect your data.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            If the ownership or control of all or part of Housedeck changes as a result of a merger, acquisition or sale of assets, we may transfer your information to the new owner, a third party entity (a "Successor")
            <br />
            <br />
            In addition, in the event of Housedeck 's bankruptcy, reorganization, receivership, or assignment for the benefit of creditors, or the application or laws or equitable principles affecting creditors' rights generally, Housedeck may not be able to control how your information is transferred, used, or treated and reserves the right to transfer the information we have collected from the users of the Platform and/or services to non-affiliated third parties in such event.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            We may investigate and disclose information from or about you, as permitted by applicable law, if we believe that such investigation or disclosure is (a) necessary to comply with legal process and law enforcement instructions and orders, such as a search warrant, order, statute, judicial proceeding, or other legal process served on us; (b) helpful to prevent, investigate, or identify possible wrongdoing in connection with the Platform; or (c) helpful to protect our rights, reputation, property, or that of our users, subsidiaries, or the public. In such an event Housedeck shall be under no obligation to inform you or seek your approval or consent.
          </Typography>
          ...
          >
            Online and during your interactions with Housedeck
          </Typography>


          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            Housedeck shall take reasonable steps to help protect your rights of privacy and your information (personal or otherwise) in an effort to prevent loss, misuse, unauthorized access, disclosure, alteration, or destruction of such information, in compliance with the applicable laws. This Platform uses physical, electronic, and administrative procedures to safeguard the confidentiality of your information. SSL encryption is used to protect your personal information online, and we also take several steps to protect your personal information in our facilities. Access to your personal information is restricted. Only employees and Partners (Design & Service) who need access to your personal information to perform a specific job or provide a service are granted access to your personal information. Finally, we rely on third-party service providers for the physical security of some of our computer hardware. We believe that their security procedures are adequate. For example, when you visit our Platform you access servers that are kept in a secure physical environment, behind a locked cage and an electronic firewall. Housedeck assumes no liability or responsibility for disclosure of your information due to errors in transmission, unauthorized third party access, or other causes beyond its control.
            <br />
            <br />
            At times we may retain third parties to analyse data we collect on our Platform, and to administer the services provided (such as shipping, web hosting, etc. as described above), solely to help us provide and improve our products, services and Platform. These suppliers and other third parties are not authorized by us to use your personal information in any other way. We may have to use personal information to investigate complaints and protect Housedeck and its members, in compliance with the law, your Membership Agreement and Housedeck policies.
            <br />
            <br />
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            We may send promotional or informational emails to you. You may opt out of receiving promotional emails from Housedeck the opt-out instructions contained in the email. Please note that if you opt out, we may still send you non-promotional messages, such as meeting invites, project progress, etc.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            You may choose to withdraw your consent provided hereunder at any point in time. Such withdrawal of the consent must be sent in writing to care@housedecklite.com. In case you do not provide your consent or later withdraw your consent, we request you not to access the Platform and use the services and also reserve the right to not provide you any services on the Platform. In such a scenario, Housedeck may delete your information (personal or otherwise) or de-identify it so that it is anonymous and not attributable to you.
          </Typography>
          ...
          <Typography sx={{ mt: 6, fontSize: "16px" }}>
            In the event You have any grievances relating to the Privacy Policy, please inform Housedeck within 24 hours of occurrence of the instance from which the grievance has arisen, by writing an email to the Grievance Officer at <a style={{ color: 'pink' }} href="mailto: care@housedeck.in">care@housedeck.in</a>.
          </Typography>
