...
export const GlobalServicesBottomListAvailable = [
  ...
  { name: "Home services questions", url: '/faqs' },
...
export const FooterLink = [
  ...
  { name: "FAQs", url: "/faqs" },
  { name: "Housedeck Partner (Home Services)", url: "/housedeck-partner-(Terms-of-Use)" },
];
...
export const SearchBar = {
  'bangalore': [
    { value: "Home Painting", url: "/service=Home Painting" },
    { value: "Home Cleaning", url: "/service=Home Cleaning" },
...
export const ServiceWithImage = {
  'bangalore': [
    ...
    // fixed data
    {
      ...
      offer: "",
      tag: true,
      takeToPath: '/service=Home Painting',
